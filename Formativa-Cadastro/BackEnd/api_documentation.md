...
Esta documentação é destinada à equipe de frontend para integração com a API da Cantina Bella Vita. A API Rest fornece endpoints completos para gerenciar Produtos, Cardápios e Pedidos.
...
GET /produtos/:id
Busca detalhes de um produto pelo seu id.
...
Resposta de Sucesso (201 Created): Retorna a chave "pedido" com o id gerado e o total recém calculado.
